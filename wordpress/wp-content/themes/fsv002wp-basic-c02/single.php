					...
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'individual-post' ); ?>>
						...
						<header class="main-content-header">
							...
							<div class="entry-meta">
								...
								<?php fsv002wpbasic_entry_meta(); ?>

								<?php if ( is_user_logged_in() ) : ?><?php edit_post_link( __( 'Edit', 'fsv002wpbasic' ), '<p class="post-edit-link-base">', '</p>' ); ?></p><?php endif; ?>
						...
						<nav class="nav-single">
							...
							<?php if ( get_adjacent_post( false , '' , true ) ) : ?>
								...
								<?php previous_post_link( '%link' , __( 'Previous Post', 'fsv002wpbasic' ) ); ?>
							...
							<?php if ( get_adjacent_post( false , '' , false ) ) : ?>
								...
								<?php next_post_link( '%link' , __( 'Next Post', 'fsv002wpbasic' ) ); ?>
