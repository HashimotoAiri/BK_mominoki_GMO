...
function fsv002wpbasic_get_theme_options() {
	return get_option( 'fsv002wpbasic_c02_theme_options', fsv002wpbasic_get_default_theme_options() );
}
...
function fsv002wpbasic_customize_register( $wp_customize ) {
	...
	/* $wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[color_scheme]', array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_color_scheme', array(
		...
		'section'  => 'colors',
		'settings' => 'fsv002wpbasic_c02_theme_options[color_scheme]',
		'type'     => 'radio',
		'choices'  => $choices,
		'priority' => 5,
	) ); */
	...
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[header_logo]' , array(
		'default'   => '',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'fsv002wpbasic_header_logo', array(
		...
		'settings'	=> 'fsv002wpbasic_c02_theme_options[header_logo]',
	) ) );
	...
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[link_sitemap]' , array(
		'default'   => 'http://',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'esc_url',
	...
	$wp_customize->add_control( 'fsv002wpbasic_link_sitemap' , array(
		...
		'settings' => 'fsv002wpbasic_c02_theme_options[link_sitemap]',
		'type'     => 'text',
		'priority' => 1,
	) );

	// Header Text Area - Link Contact
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[link_contact]' , array(
		'default'   => 'mailto:',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'esc_url',
	...
	$wp_customize->add_control( 'fsv002wpbasic_link_contact' , array(
		...
		'section'  => 'fsv002wpbasic_header_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[link_contact]',
		'type'     => 'text',
		'priority' => 2,
	) );

	// Header Text Area - Large Text
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[head_large_text]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_head_large_text' , array(
		...
		'section'  => 'fsv002wpbasic_header_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[head_large_text]',
		'type'     => 'text',
		'priority' => 3,
	) );

	// Header Text Area - Normal Text
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[head_text]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_head_text' , array(
		...
		'section'  => 'fsv002wpbasic_header_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[head_text]',
		'type'     => 'text',
		'priority' => 4,
	) );
	...
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide1_url]' , array(
		'default'   => '#',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'esc_url',
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide1_url' , array(
		...
		'settings' => 'fsv002wpbasic_c02_theme_options[slide1_url]',
		'type'     => 'text',
		'priority' => 2,
	) );

	// Slide Settings - Slide 1 Picture
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide1_pic]' , array(
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'fsv002wpbasic_slide1_pic', array(
		...
		'section'	=> 'fsv002wpbasic_slide_settings',
		'settings'	=> 'fsv002wpbasic_c02_theme_options[slide1_pic]',
		'priority' => 1,
	) ) );

	// Slide Settings - Slide 1 Caption
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide1_cap]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide1_cap' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide1_cap]',
		'type'     => 'text',
		'priority' => 3,
	) );

	// Slide Settings - Slide 2 URL
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide2_url]' , array(
		'default'   => '#',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'esc_url',
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide2_url' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide2_url]',
		'type'     => 'text',
		'priority' => 5,
	) );

	// Slide Settings - Slide 2 Picture
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide2_pic]' , array(
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'fsv002wpbasic_slide2_pic', array(
		...
		'section'	=> 'fsv002wpbasic_slide_settings',
		'settings'	=> 'fsv002wpbasic_c02_theme_options[slide2_pic]',
		'priority' => 4,
	) ) );

	// Slide Settings - Slide 2 Caption
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide2_cap]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide2_cap' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide2_cap]',
		'type'     => 'text',
		'priority' => 6,
	) );

	// Slide Settings - Slide 3 URL
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide3_url]' , array(
		'default'   => '#',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'esc_url',
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide3_url' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide3_url]',
		'type'     => 'text',
		'priority' => 8,
	) );

	// Slide Settings - Slide 3 Picture
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide3_pic]' , array(
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'fsv002wpbasic_slide3_pic', array(
		...
		'section'	=> 'fsv002wpbasic_slide_settings',
		'settings'	=> 'fsv002wpbasic_c02_theme_options[slide3_pic]',
		'priority' => 7,
	) ) );

	// Slide Settings - Slide 3 Caption
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide3_cap]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide3_cap' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide3_cap]',
		'type'     => 'text',
		'priority' => 9,
	) );

	// Slide Settings - Slide 4 URL
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide4_url]' , array(
		'default'   => '#',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'esc_url',
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide4_url' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide4_url]',
		'type'     => 'text',
		'priority' => 11,
	) );

	// Slide Settings - Slide 4 Picture
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide4_pic]' , array(
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'fsv002wpbasic_slide4_pic', array(
		...
		'section'	=> 'fsv002wpbasic_slide_settings',
		'settings'	=> 'fsv002wpbasic_c02_theme_options[slide4_pic]',
		'priority' => 10,
	) ) );

	// Slide Settings - Slide 4 Caption
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide4_cap]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide4_cap' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide4_cap]',
		'type'     => 'text',
		'priority' => 12,
	) );

	// Slide Settings - Slide 5 URL
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide5_url]' , array(
		'default'   => '#',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'esc_url',
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide5_url' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide5_url]',
		'type'     => 'text',
		'priority' => 14,
	) );

	// Slide Settings - Slide 5 Picture
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide5_pic]' , array(
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'fsv002wpbasic_slide5_pic', array(
		...
		'section'	=> 'fsv002wpbasic_slide_settings',
		'settings'	=> 'fsv002wpbasic_c02_theme_options[slide5_pic]',
		'priority' => 13,
	) ) );

	// Slide Settings - Slide 5 Caption
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[slide5_cap]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_slide5_cap' , array(
		...
		'section'  => 'fsv002wpbasic_slide_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[slide5_cap]',
		'type'     => 'text',
		'priority' => 15,
	) );
	...
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[welcome_title]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_welcome_title' , array(
		...
		'settings' => 'fsv002wpbasic_c02_theme_options[welcome_title]',
		'type'     => 'text',
		'priority' => 1,
	) );

	// Welcome Message Component - Message Text
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[welcome_text]' , array(
	...
	$wp_customize->add_control( 'fsv002wpbasic_welcome_text' , array(
		...
		'section'  => 'fsv002wpbasic_welcome_settings',
		'settings' => 'fsv002wpbasic_c02_theme_options[welcome_text]',
		'type'     => 'text',
		'priority' => 2,
	) );
	...
	$wp_customize->add_setting( 'fsv002wpbasic_c02_theme_options[foot_text]' , array(
		'default'   => 'Copyright',
		'type'      => 'option',
		'capability'=> 'edit_theme_options',
		'sanitize_callback' => 'fsv002wpbasic_text_sanitize',
	...
	$wp_customize->add_control( 'fsv002wpbasic_foot_text' , array(
		...
		'settings' => 'fsv002wpbasic_c02_theme_options[foot_text]',
		'type'     => 'text',
		'priority' => 1,
	) );
