	...
	<div id="masthead" class="site-header-area" role="banner">
		...
		<div class="component-inner">
			...
			<?php endif;
				...
				<h2 class="site-description">ＪＲ・東京メトロ荻窪駅より徒歩３分<br>相続登記・会社設立（起業）・借金問題の専門家</h2>
			...
			<div id="header-widget-area"><?php
				...
				<?php endif; if ( $opHeadText ) : ?>
				<p class="hw_text_large"><img src="<?php bloginfo('template_url'); ?>/images/soudan_muryo.png" class="soudan_muryo"><a href="tel:0353474715"><?php echo $opHeadLargeText; ?></a></p>
				<?php endif; if ( $opHeadLargeText ) : ?><p class="hw_text"><?php echo $opHeadText; ?></p><?php endif; ?>
...
<img src="http://mominoki-shihou.site/wp-content/uploads/2015/10/top_07-1200x300.png">
