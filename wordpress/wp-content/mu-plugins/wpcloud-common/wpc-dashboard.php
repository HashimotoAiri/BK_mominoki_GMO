...
//		add_action( 'admin_menu' , array(&$this, 'add_news_link') );
    ...
    public function add_menu()
    {
        $page = add_menu_page($this->pageinfo['title'], $this->pageinfo['title'], 'administrator',
            $this->pageinfo['page'], array(&$this, 'read_page_content'), WPC_PLUGIN_URL . '/images/common/icon.png');
        $this->create_submenu_page();
    }

    public function add_admin_style()
    {
        wp_enqueue_style('wpcloud_admin_menu', WPC_PLUGIN_URL . '/css/common/admin-menu.css', array(),
            WPC_PLUGIN_VERSION);
    }
    ...
    {
        wp_enqueue_style('wpcloud_common_style', WPC_PLUGIN_URL . '/css/common/common.css', array(),
            WPC_PLUGIN_VERSION);
    }
    ...
    {
        global $submenu;
        $submenu[$this->pageinfo['page']][] = array(
            'Control Panel',
            'administrator',
            'javascript:void(window.open("https://cp.wpcloud.jp/Login/DashBoard/"));',
            'Control Panel'
        );
    }
    ...
    public function add_support_link()
    {
        ...
        $submenu[$this->pageinfo['page']][] = array(
            'Support',
            'administrator',
            'javascript:void(window.open("http://support.wpcloud.jp"));',
            'Support'
        );
    }
    ...
    public function add_news_link()
    {
        ...
        $submenu[$this->pageinfo['page']][] = array(
            'Themes&Plugins',
            'administrator',
            'javascript:void(window.open("http://news.wpcloud.jp"));',
            'Themes&Plugins'
        );
    }
